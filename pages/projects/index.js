...
export default function ProjectsPage({projects, miniProjects}) {
    ...
    const responsive = {
      ...
      const customLeftArrow = (
        <div className=" bg-indigo-700 hover:bg-indigo-800 absolute left-0 text-center p-2 lg:p-3 cursor-pointer rounded-full">
          ...
          <ArrowLeftIcon className="w-4 md:w-5 lg:w-6" />
        </div>
      );
    
      const customRightArrow = (
        <div className=" bg-indigo-700 hover:bg-indigo-800 absolute right-0 text-center p-2 lg:p-3 cursor-pointer rounded-full">
          {/* <svg xmlns="http://www.w3.org/2000/svg" className="h-6 text-white w-fit" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3" />
          </svg> */}
          <ArrowRightIcon className="w-4 md:w-5 lg:w-6" />
        </div>
      );
    ...
    return <article id='projects-page' className="FADE">
        ...
        <section id='next-projects' className="my-12 lg:my-16">
          <h2 className='text-center gradient-1 text-2xl lg:text-3xl font-bold my-4'>Next.js ({next.length})</h2>
        ...
        <section id='react-projects' className="my-12 lg:my-16">
          <h2 className='text-center gradient-1 text-2xl lg:text-3xl font-bold my-4'>React ({react.length})</h2>
          <Carousel infinite autoPlay={false} shouldResetAutoplay={false} keyBoardControl responsive={responsive} customLeftArrow={customLeftArrow} customRightArrow={customRightArrow} >
        ...
        <section id='django-projects' className="my-12 lg:my-16">
          <h2 className='text-center gradient-1 text-2xl lg:text-3xl font-bold my-4'>Django ({django.length})</h2>
          <Carousel infinite autoPlay={false} shouldResetAutoplay={false} keyBoardControl responsive={responsive} customLeftArrow={customLeftArrow} customRightArrow={customRightArrow} >
        ...
        <section id='mini-projects' className="my-12 lg:my-16">
          <h2 className='text-center gradient-1 text-2xl lg:text-3xl font-bold my-4'>Mini-Projects</h2>
            <div id='javascript-projects'>
              <h3 className='text-center gradient-1 text-xl lg:text-2xl my-2 lg:my-3'>JavaScript ({javascript.length})</h3>
              <Carousel infinite autoPlay={false} shouldResetAutoplay={false} keyBoardControl responsive={responsive} customLeftArrow={customLeftArrow} customRightArrow={customRightArrow} >
            ...
            <div id='python-projects'>
              <h3 className='text-center gradient-1 text-xl lg:text-2xl my-2 lg:my-3'>Python ({python.length})</h3>
              <Carousel infinite autoPlay={false} shouldResetAutoplay={false} keyBoardControl responsive={responsive} customLeftArrow={customLeftArrow} customRightArrow={customRightArrow} >
